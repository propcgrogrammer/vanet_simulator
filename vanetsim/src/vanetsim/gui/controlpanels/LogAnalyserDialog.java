...
public final class LogAnalyserDialog extends JDialog implements ActionListener{
	...
	private JComboBox chooseAttackType_ = new JComboBox();	
	...
	public LogAnalyserDialog(){
        ...
        //Radio button to choice silent-periods
		...
		c.gridx = 1;
		tuneTime_.setValue(new Double(1.15));
		add(tuneTime_, c);
	 ...
	 */
	public JComboBox getChooseAttackType_() {
	 ...
	 */
	public void setChooseAttackType_(JComboBox chooseAttackType_) {
