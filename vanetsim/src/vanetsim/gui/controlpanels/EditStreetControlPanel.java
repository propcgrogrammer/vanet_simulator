...
public final class EditStreetControlPanel extends JPanel implements ActionListener{
	...
	private JComboBox newPresetChoice_;
	
	/** A combobox for setting street types. */
	private JComboBox newStreetTypeChoice_;
	
	/** A combobox with presets for easier street creation. */
	private JComboBox editPresetChoice_;
	...
	private JComboBox newOnewayChoice_;
	
	/** A combobox for setting oneway/twoway of edited streets. */
	private JComboBox editOnewayChoice_;
	
	/** A combobox for setting street types. */
	private JComboBox editStreetTypeChoice_;	
	...
	private final JPanel createNewPanel(){
		...
		newPresetChoice_ = new JComboBox(PRESET_STRINGS);
		...
		c.gridx = 1;
		newStreetTypeChoice_ = new JComboBox(PRESET_TYPES);
		...
		newOnewayChoice_ = new JComboBox(choices);
	...
	private final JPanel createEditPanel(){
		...
		JPanel tmpPanel = new JPanel();
		editPresetChoice_ = new JComboBox(PRESET_STRINGS);
		...
		c.gridx = 1;
		editStreetTypeChoice_ = new JComboBox(PRESET_TYPES);
		...
		c.gridx = 1;
		String[] choices = {Messages.getString("EditStreetControlPanel.twoWay"), Messages.getString("EditStreetControlPanel.oneWay"), Messages.getString("EditStreetControlPanel.reverse")};  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		editOnewayChoice_ = new JComboBox(choices);
